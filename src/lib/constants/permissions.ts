...
export const PERMISSIONS = {
  ...
  // ---- Operations modules (feature pages pending; view-gates the nav item) ----
  TRANSACTIONS_VIEW: "transactions.view",
  INVOICES_VIEW: "invoices.view",
  INVENTORY_VIEW: "inventory.view",
  CCTV_VIEW: "cctv.view",
  COMPLIMENTARY_PASSES_VIEW: "complimentary_passes.view",
...
export const PERMISSION_GROUPS: Record<string, Permission[]> = {
  ...
  Operations: [
    ...
    PERMISSIONS.COMPLIMENTARY_PASSES_VIEW,
